...
fn main() {
    App::new()
        ...
        .add_systems(OnEnter(GameState::Menu), (setup_menu, check_worlds_directory))
        .add_systems(Update, mouse_scroll.run_if(in_state(GameState::Menu)))
